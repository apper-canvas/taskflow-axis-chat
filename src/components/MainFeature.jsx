...
// Sample tasks data - moved outside component to ensure stability
const sampleTasks = [
  {
    id: '1',
  ...
  },
  {
    ...
    status: 'in-progress',
    dueDate: '2024-12-19',
    createdAt: '12/14/2024 9:00:00 AM',
...
const MainFeature = () => {
  ...
  useEffect(() => {
    ...
    if (savedTasks) {
      ...
      console.log('Loading saved tasks from localStorage:', parsedTasks.length, 'tasks')
      setTasks(parsedTasks)
    } else {
      // Load sample data if no saved tasks exist
      console.log('No saved tasks found, loading sample data:', sampleTasks.length, 'tasks')
